<#
.SYNOPSIS
Script to troubleshoot attestation issues during device enrollment with Autopilot for Pre-Provisioned deployments.

.DESCRIPTION
This module provides diagnostic tools to identify and resolve attestation problems that may occur during Autopilot Pre-Provisioned setups. Developed by Rudy Ooms.

.EXAMPLE
Check out the blog for examples and explanations: https://call4cloud.nl/2022/08/the-last-tpm-attestation-script-from-your-lover/

.LINK
More information: https://www.powershellgallery.com/packages/Autopilottestattestation/1.0.0.34
#>
